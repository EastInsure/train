...
#SBATCH -o train/logs/slurm-%j.out
#SBATCH --quotatype=reserved
#SBATCH --phx-priority=P1
#SBATCH --preempt
export OMP_NUM_THREADS=16
#export WANDB_API_KEY="xx"
#export WANDB_MODE=offline
#LOAD_PATH=/mnt/lustre/ladata/henan/176B_8_8_20221021/checkpoint
#DATA_PATH=/mnt/cache/ladata/henan/data/pretrain/bloom_tokenizer/20230212/qb_60w_en_80w/qb_60w_en_80w_text_document
#RUSH_PATH=/mnt/cache/ladata/henan/176B_ft_qb_60w_en_80w_20230213
#mkdir $RUSH_PATH
#CHECKPOINT_PATH=$RUSH_PATH/checkpoint
#TENSORBOARD_PATH=$RUSH_PATH/tensorboard
#LOGS_PATH=$RUSH_PATH/logs

DATA_PATH=data/zhihu_100000_text_document
RUSH_PATH=176B_ft_qb_60w_en_80w
mkdir $RUSH_PATH
LOAD_PATH=176B_ft_qb_60w_en_80w/checkpoint
CHECKPOINT_PATH=$RUSH_PATH/checkpoint
TENSORBOARD_PATH=$RUSH_PATH/tensorboard
LOGS_PATH=$RUSH_PATH/logs
TOKENIZER_NAME_OR_PATH=bloom_tokenizer
...
#srun --jobid $SLURM_JOBID bash -c '$LAUNCHER --node_rank $SLURM_PROCID $CMD' 2>&1 | tee $LOGS_PATH/6B7-pile.$SLURM_JOBID.out
bash -c '$LAUNCHER --node_rank ${NODE_RANK} $CMD' 2>&1 | tee $(dirname $0)/logs/${POD_NAME}.log
